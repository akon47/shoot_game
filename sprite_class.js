class SpriteClass {
  ...
  drawSprite(drawingContext, x, y, frameIndex, width, height) {
    if (this.isSpriteLoaded) {
      const srcSpritePosition =
        this.spriteSrcPositions[frameIndex === undefined ? 0 : frameIndex];
...
class SurvivorCharacterClass {
  constructor() {
    ...
    this.characters["flashlight"]["idle"] = {
      baseSrc:
        "images/Survivor/flashlight/idle/survivor-idle_flashlight_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 94,
    ...
    this.characters["flashlight"]["meleeattack"] = {
      baseSrc:
        "images/Survivor/flashlight/meleeattack/survivor-meleeattack_flashlight_{index}.png",
      totalFrames: 15,
      fps: 10,
      images: [],
      centerX: 100,
    ...
    this.characters["flashlight"]["move"] = {
      baseSrc:
        "images/Survivor/flashlight/move/survivor-move_flashlight_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 94,
    ...
    this.characters["knife"]["idle"] = {
      baseSrc: "images/Survivor/knife/idle/survivor-idle_knife_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 107,
    ...
    this.characters["knife"]["meleeattack"] = {
      baseSrc:
        "images/Survivor/knife/meleeattack/survivor-meleeattack_knife_{index}.png",
      totalFrames: 15,
      fps: 10,
      images: [],
      centerX: 104,
    ...
    this.characters["knife"]["move"] = {
      baseSrc: "images/Survivor/knife/move/survivor-move_knife_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 107,
    ...
    this.characters["handgun"]["idle"] = {
      baseSrc: "images/Survivor/handgun/idle/survivor-idle_handgun_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 97,
    ...
    this.characters["handgun"]["meleeattack"] = {
      baseSrc:
        "images/Survivor/handgun/meleeattack/survivor-meleeattack_handgun_{index}.png",
      totalFrames: 15,
      fps: 10,
      images: [],
      centerX: 104,
    ...
    this.characters["handgun"]["move"] = {
      baseSrc: "images/Survivor/handgun/move/survivor-move_handgun_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 102,
    ...
    this.characters["handgun"]["reload"] = {
      baseSrc:
        "images/Survivor/handgun/reload/survivor-reload_handgun_{index}.png",
      totalFrames: 15,
      fps: 10,
      images: [],
      centerX: 101,
    ...
    this.characters["handgun"]["shoot"] = {
      baseSrc:
        "images/Survivor/handgun/shoot/survivor-shoot_handgun_{index}.png",
      totalFrames: 3,
      fps: 10,
      images: [],
      centerX: 99,
    ...
    this.characters["rifle"]["idle"] = {
      baseSrc: "images/Survivor/rifle/idle/survivor-idle_rifle_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 95,
    ...
    this.characters["rifle"]["meleeattack"] = {
      baseSrc:
        "images/Survivor/rifle/meleeattack/survivor-meleeattack_rifle_{index}.png",
      totalFrames: 15,
      fps: 10,
      images: [],
      centerX: 115,
    ...
    this.characters["rifle"]["move"] = {
      baseSrc: "images/Survivor/rifle/move/survivor-move_rifle_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 95,
    ...
    this.characters["rifle"]["reload"] = {
      baseSrc: "images/Survivor/rifle/reload/survivor-reload_rifle_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 101,
    ...
    this.characters["rifle"]["shoot"] = {
      baseSrc: "images/Survivor/rifle/shoot/survivor-shoot_rifle_{index}.png",
      totalFrames: 3,
      fps: 10,
      images: [],
      centerX: 94,
    ...
    this.characters["shotgun"]["idle"] = {
      baseSrc: "images/Survivor/shotgun/idle/survivor-idle_shotgun_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 95,
    ...
    this.characters["shotgun"]["meleeattack"] = {
      baseSrc:
        "images/Survivor/shotgun/meleeattack/survivor-meleeattack_shotgun_{index}.png",
      totalFrames: 15,
      fps: 10,
      images: [],
      centerX: 115,
    ...
    this.characters["shotgun"]["move"] = {
      baseSrc: "images/Survivor/shotgun/move/survivor-move_shotgun_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 95,
    ...
    this.characters["shotgun"]["reload"] = {
      baseSrc:
        "images/Survivor/shotgun/reload/survivor-reload_shotgun_{index}.png",
      totalFrames: 20,
      fps: 10,
      images: [],
      centerX: 101,
    ...
    this.characters["shotgun"]["shoot"] = {
      baseSrc:
        "images/Survivor/shotgun/shoot/survivor-shoot_shotgun_{index}.png",
      totalFrames: 3,
      fps: 10,
      images: [],
      centerX: 94,
  ...
  drawCharacter(drawingContext, playerClass, cameraClass) {
    ...
    if (playerClass) {
      ...
      let frameInfo = characterInfo["idle"];
      ...
      if (frameInfo) {
        ...
        if (cameraClass.containsBox(userX, userY, userWidth, userHeight)) {
          ...
          const img =
            frameInfo.images[
              (currentStatusFrame !== undefined
                ? currentStatusFrame
                : frameCount) % frameInfo.images.length
            ];
          ...
          if (playerClass.getHp() < 100) {
            ...
            drawingContext.fillStyle =
              playerClass.getHp() < 50 ? "red" : "lightgreen";
            drawingContext.beginPath();
            drawingContext.rect(
              x - 15,
...
class NpcCharacterClass {
  constructor() {
    ...
    this.characters["skeleton"]["idle"] = {
      baseSrc: "images/Monster/skeleton/idle/skeleton-idle_{index}.png",
      totalFrames: 17,
      fps: 10,
      images: [],
      centerX: 94,
    ...
    this.characters["skeleton"]["meleeattack"] = {
      baseSrc:
        "images/Monster/skeleton/meleeattack/skeleton-attack_{index}.png",
      totalFrames: 9,
      fps: 10,
      images: [],
      centerX: 84,
    ...
    this.characters["skeleton"]["move"] = {
      baseSrc: "images/Monster/skeleton/move/skeleton-move_{index}.png",
      totalFrames: 17,
      fps: 10,
      images: [],
      centerX: 99,
      ...
      if (frameInfo) {
        ...
        if (cameraClass.containsBox(userX, userY, userWidth, userHeight)) {
          ...
          if (npcClass.getHp() < 100) {
            ...
            drawingContext.fillStyle =
              npcClass.getHp() < 50 ? "red" : "lightgreen";
            drawingContext.beginPath();
            drawingContext.rect(
              x - 15,
              y - userHeight / 2 - 5 - 3 - 3,
          ...
          if (debugClass.debugGraphicsVisible) {
            if (
              npcClass.getDestinationX() !== npcClass.getPositionX() ||
              npcClass.getDestinationY() !== npcClass.getPositionY()
            ) {
              const destX =
                npcClass.getDestinationX() -
                viewboxLeft +
                npcClass.getWidth() / 2;
              const destY =
                npcClass.getDestinationY() -
                viewboxTop +
                npcClass.getHeight() / 2;
